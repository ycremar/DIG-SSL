...
if __name__ == '__main__':
    ...
    mvgrl = NodeMVGRL(embed_dim, z_n_dim=embed_dim, diffusion_type='ppr', num_nodes=2000)

    evaluator = EvalUnsupevised(dataset, train_mask, val_mask, test_mask, log_interval=200)
